...
public class TransferenciaIngles extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TransferenciaIngles
     */
    public TransferenciaIngles() {
        initComponents();
        setLocationRelativeTo(null);
    }
    public TransferenciaIngles(String name,int numeroCuenta){
        initComponents();
        this.usuario=name;
 ...
 private void actualizarLista() {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("N° ACOUNT");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 110, 30));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 480, 90, 30));
        ...
        jLabel4.setText("TRANSFERS");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, 220, 40));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("BALANCE TO BE TRANSFERED");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, 260, 30));
        ...
        jPanel1.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 90, -1));
        ...
        if(!txtCuentaTransferir.getText().equals("")&&!txtSaldoTransferir.getText().equals("")){
            ...
            if (cuentaExiste(Integer.parseInt(txtCuentaTransferir.getText()))){
                if(saldo(numeroCuenta) >= (Double.parseDouble(txtSaldoTransferir.getText()))){
                    ...
                    FacturaIngles factura =new FacturaIngles(usuario,numeroCuenta,"Transeferencia",Double.parseDouble(txtSaldoTransferir.getText()));
                ...
                JOptionPane.showMessageDialog(null, "The account does not exist", "Error", JOptionPane.INFORMATION_MESSAGE);

            }

        }else {
            JOptionPane.showMessageDialog(null, "Please fill in all the boxes.", "Error", JOptionPane.INFORMATION_MESSAGE);
