...
public class FacturaIngles extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FacturaIngles
     */
    public FacturaIngles() {
        initComponents();
        setLocationRelativeTo(null);
    }
    public FacturaIngles(String usu,int numerocuenta,String tipoTransaccion,double monto) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtFecha.setText("DATE / TIME :");
        jPanel1.add(txtFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 140, 20));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 3, 36)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("INVOICE");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 160, 50));
        ...
        jPanel1.add(MONTO, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, 70, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("TYPE OF TRANSACTION");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, 170, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("N° ACCOUNT");
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 90, -1));
        ...
        txtNumeroCuenta.setText("DATE / TIME :");
        jPanel1.add(txtNumeroCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, 140, -1));

        txtMonto.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        txtMonto.setForeground(new java.awt.Color(255, 255, 255));
        txtMonto.setText("DATE / TIME :");
        jPanel1.add(txtMonto, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 150, -1));
        ...
        txtTipoTransaccion.setText("DATE / TIME :");
        jPanel1.add(txtTipoTransaccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, 140, -1));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-160, 0, -1, 360));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturaIngles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturaIngles().setVisible(true);
            }
        });
    }
