 ...
 * @author Jhonny
 */
public class CuentasQuechua extends javax.swing.JFrame {

    /**
     * Creates new form Cuentas
     */
    public CuentasQuechua() {
        initComponents();
    ...
    public CuentasQuechua(String usu) {
        initComponents();
        this.usuario=usu;
        cargar();
        cargarCuentas(usu);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("AKLLAY IMAPAQ QILLQANA WANTINAKUYTA RUWASUNKI");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 560, 40));
        ...
        btnAgregarCuenta.setText("QILLQANATA YAPAY");
        ...
        jPanel1.add(btnAgregarCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 360, -1, -1));
        ...
        btnCambiarContraseña.setText("SIMIKAMATA KATARIY");
        ...
        jPanel1.add(btnCambiarContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 360, -1, -1));
                    ...
                    JButton button = new JButton( String.valueOf(principal.getListaCuenta().get(i).getNumeroCuenta())+ " " + nombreMoneda(principal.getListaCuenta().get(i).getMoneda()));
                      ...
                      button.addActionListener(new ActionListener() {
                       public void actionPerformed(ActionEvent e) {
                           MenuQuechua menu = new MenuQuechua(usuario,numeroCuentaAux);
    ...
    private void btnAgregarCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarCuentaActionPerformed
        CrearCuentaQuechua cuenta = new CrearCuentaQuechua (usuario);
    ...
    private void btnCambiarContraseñaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCambiarContraseñaActionPerformed
        CambioContrasenaQuechua ventana =new CambioContrasenaQuechua(usuario);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        IngresoPinQuechua ventana =new IngresoPinQuechua(usuario);
        ventana.setVisible(true);
        ventana.setLocationRelativeTo(null);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuentasQuechua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuentasQuechua().setVisible(true);
            }
        });
    }
