...
public class HistorialQuechua extends javax.swing.JFrame {
     ...
     */
    public HistorialQuechua() {
        initComponents();
        setLocationRelativeTo(null);
    }
    public HistorialQuechua(String name,int numerocuen){
        initComponents();
        this.usuario=name;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BANKUMANTAWI WILLANAKUY ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 560, 70));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 540, 140, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistorialQuechua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistorialQuechua().setVisible(true);
            }
        });
    }
