...
public class Saldo extends javax.swing.JFrame {
    ...
    public Saldo() {
     ...
     /**
     * Constructor de Saldo con parámetros.
     *
     * @param name El nombre del usuario.
     * @param numerocuenta El número de la cuenta del usuario.
    ...
    public Saldo(String name, int numerocuenta,double saldo){
        ...
        txtSaldo.setText(saldo + ""); // Muestra el saldo en el campo de texto correspondiente
        cargar(); // Carga los datos del archivo
        txtMoneda.setText(tipoMoneda(numerocuenta)); // Muestra el tipo de moneda
    
    }
    /**
     * Determina el tipo de moneda de acuerdo al número de cuenta.
     *
     * @param numerocuenta El número de cuenta del usuario.
     * @return El símbolo de la moneda ("$" para dólares, "Bs" para bolivianos).
     */
        ...
        for (int i = 0; i < principal.getListaCuenta().size(); i++) {
            if (principal.getListaCuenta().get(i).getNumeroCuenta() == numerocuenta) {
                if (principal.getListaCuenta().get(i).getMoneda().equals("Dolares")) {
                    res = "$"; // Si la moneda es dólar, asigna el símbolo "$"
                } else {
                    res = "Bs"; // Si no, asigna "Bs" (bolivianos)
                }
            }
        }
        return res;
    ...
    /**
     * Carga los datos del archivo "Cajero.txt" en la lista principal.
     */
    public void cargar (){
...
/**
     * Obtiene el saldo de la cuenta según el número de cuenta proporcionado.
     *
     * @param numeroCuenta El número de cuenta del usuario.
    ...
    private void initComponents() {
        ...
        txtSaldo.setText("$$$");
        jPanel1.add(txtSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 190, 50));
        ...
        txtMoneda.setText("$$$");
        jPanel1.add(txtMoneda, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 90, 50));
