...
/**
 * La clase CambioContrasena es en la cual cambiamos nuestra contrasena.
 * Permite al usuario cambiar su contraseña actual por una nueva.
 * aclarar que en las interfaces de cambiocontrasenaingles
 * cambiocontrasenaquechua no agregue nada ya que se base en esta interfaz principal y seria repetir lo mismo
 * @author Jhonny
 */
public class CambioContrasena extends javax.swing.JFrame {
    //variable de instancia
     public String usuario = "";// Nombre de usuario para el que se está cambiando la contraseña
   // public int numeroCuenta = 00;
    Principal principal = new Principal ();// Instancia de la clase Principal para manejar la información del sistema
    /**
     * Constructor de la clase CambioContrasena.
     * Inicializa la interfaz gráfica de usuario y la posiciona en el centro de la pantalla.
     */
    ...
    /**
     * @param name El nombre de usuario para el que se está cambiando la contraseña.
     */
    public CambioContrasena(String name) {
        initComponents();
        cargar();// Carga la información del sistema desde un archivo
        this.usuario=name;    //establece el nombre de usuario
        
    }
    /**
     * Método para cargar la información del sistema desde un archivo.
     */
    public void cargar (){
     ...
     /**
     * Método para actualizar la información del sistema en el archivo.
     */
 private void actualizarLista() {
    ...
    private void initComponents() {
     ...
     /**
     * Método para manejar el evento de clic en el botón "LISTO" para cambiar la contraseña.
     * Verifica la contraseña actual, la nueva contraseña y la repeticion de la nueva contraseña.
     * Realiza el cambio de contraseña si todas las verificaciones son exitosas.
     * 
    ...
    /**
     * Método para cambiar la contraseña del usuario en la información del sistema.
     * 
    ...
    /**
     * Método para verificar si las contraseñas nueva y repetida coinciden.
     * 
     * @param contraseña1 La primera contraseña ingresada.
     * @param contraseña2 La segunda contraseña ingresada (repetida).
    ...
    /**
     * Método para verificar si la contraseña actual ingresada coincide con la del usuario.
     * 
     * @param contraseña La contraseña actual ingresada por el usuario.
    ...
    //boton para regresar a la interfaz de  cuentas y con el dispose se cierra al darle al boton x si solo
...
//mouseclicked para que se cierre la interfaz cuando lo presionemos
