 ...
 * @author MAGNER
 */
public class RegistroIngles extends javax.swing.JFrame {
    public Principal principal = new Principal();
    
    public String usuario = "null";
    /**
     * Creates new form RegistroIngles
     */
    public RegistroIngles(String name){
        initComponents();
        this.usuario=name;
        cargar();
    }
    public RegistroIngles() {
        initComponents();
 ...
 private void actualizarLista() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 70, 320, 40));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 132, 130, -1));
        ...
        jPanel1.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 342, 30));
        ...
        jPanel1.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, 337, -1));
        ...
        jPanel1.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 340, 30));
        ...
        jButton7.setText("CREATE AN ACCOUNT");
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 460, -1, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 500, -1, -1));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (!txtNombre.getText().equals("") && !txtCi.getText().equals("")&&!txtDireccion.getText() .equals("")&&!txtApellido.getText() .equals("")&&!txtUsuario.getText() .equals("")&&!txtTelefono.getText() .equals("")&&!txtContraseña.getText() .equals("")){
            if (!existeUsuario(txtUsuario.getText())){
                ...
                actualizarLista();
                CuentasIngles cuentas = new CuentasIngles (txtUsuario.getText());
                cuentas.setLocationRelativeTo(null);
                cuentas.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(null, "The user already exists ", "Error", JOptionPane.INFORMATION_MESSAGE);

            }
        } else {

            JOptionPane.showMessageDialog(null, "Please complete all fields.", "Error", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroIngles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroIngles().setVisible(true);
            }
        });
    }
